...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v19_targeted\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v19_targeted\classifier_calibrated")
