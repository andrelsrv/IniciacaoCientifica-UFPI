"""Calibra a confianca (fracao de votos das arvores) do classificador v19
(retreino com dados mirados nas 4 celulas fracas: AB/BC baixa-Z, ABG/BCG
alta-Z) usando o conjunto de validacao (nunca usado no treino), com
CalibratedClassifierCV (sigmoid/Platt)."""
...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v28_weighted_specialists\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v28_weighted_specialists\classifier_calibrated")
...
def main() -> None:
    ...
    artifact_calibrated["calibration_method"] = "sigmoid (Platt), fit on validation split (v9 boundary)"
