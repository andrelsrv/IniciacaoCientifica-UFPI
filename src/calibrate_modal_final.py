...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_modal_final\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_modal_final\classifier_calibrated")
