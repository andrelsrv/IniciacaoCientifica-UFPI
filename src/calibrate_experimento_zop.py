...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\experimento_zero_over_positive\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\experimento_zero_over_positive\classifier_calibrated")
