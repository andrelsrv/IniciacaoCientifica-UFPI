...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\campaign_v6_ab_focus\classifier_robust_v5\robust_classifier_400300.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v18_400_300\classifier_calibrated")
