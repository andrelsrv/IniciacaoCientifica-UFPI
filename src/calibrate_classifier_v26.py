...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v26_boost\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v26_boost\classifier_calibrated")
