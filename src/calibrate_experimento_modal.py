...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\experimento_modal\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\experimento_modal\classifier_calibrated")
