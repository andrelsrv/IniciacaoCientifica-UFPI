"""Validacao final independente do classificador v4 (900 casos de treino).
Lote totalmente novo, semente nunca usada antes."""
...
OUTPUT_ROOT = Path(r"C:\RESULTPESQUISA\quick_check_v4_final")
CLASSIFIER_V4 = Path(r"C:\RESULTPESQUISA\campaign_v5_900\classifier_robust_v4\robust_classifier.joblib")
...
def main() -> None:
    ...
    print(f"\nAcuracia geral (v4, {n} casos novos): {accuracy:.1%}")
    ...
    report_path = OUTPUT_ROOT / "quick_check_v4_report.json"
