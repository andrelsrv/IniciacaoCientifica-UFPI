...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v23_abgfocus\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v23_abgfocus\classifier_calibrated")
