...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v20_noboost\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v20_noboost\classifier_calibrated")
