...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_focused_0_300\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_focused_0_300\classifier_calibrated")
