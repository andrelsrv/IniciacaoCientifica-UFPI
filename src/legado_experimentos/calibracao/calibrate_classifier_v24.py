...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v24_bolted\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v24_bolted\classifier_calibrated")
