...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_dense_angle\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_dense_angle\classifier_calibrated")
