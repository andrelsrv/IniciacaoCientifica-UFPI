...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v25_rebalanced\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v25_rebalanced\classifier_calibrated")
