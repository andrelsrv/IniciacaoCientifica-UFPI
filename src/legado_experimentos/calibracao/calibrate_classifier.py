"""Calibra a confianca (fracao de votos das arvores) do classificador v5
...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\campaign_v6_ab_focus\classifier_robust_v5\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\campaign_v6_ab_focus\classifier_calibrated_v5")
...
def main() -> None:
    ...
    artifact_calibrated["calibration_method"] = "sigmoid (Platt), fit on validation split (100 casos)"
