...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\campaign_v6_ab_focus\classifier_robust_v5\robust_classifier_boost.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v18_boost\classifier_calibrated")
