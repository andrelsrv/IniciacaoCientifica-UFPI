...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v21_highz\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v21_highz\classifier_calibrated")
