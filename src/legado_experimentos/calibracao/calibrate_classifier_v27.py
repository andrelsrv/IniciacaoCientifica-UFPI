...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v27_specialists\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v27_specialists\classifier_calibrated")
