...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v30_overnight\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v30_overnight\classifier_calibrated")
