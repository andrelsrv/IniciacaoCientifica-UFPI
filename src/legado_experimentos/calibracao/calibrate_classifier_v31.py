...
CLASSIFIER_PATH = Path(r"C:\RESULTPESQUISA\retrain_v31_capped_specialists\robust_classifier.joblib")
OUTPUT_DIR = Path(r"C:\RESULTPESQUISA\retrain_v31_capped_specialists\classifier_calibrated")
